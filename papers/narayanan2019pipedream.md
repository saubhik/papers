...
![Timeline with MP](images/narayanan2019pipedream/model-parallelism.png){width=50%}
...
![Timeline with PP](images/narayanan2019pipedream/pipeline-parallelism.png){width=50%}
...
![PipeDream Config](images/narayanan2019pipedream/pipedream-config.png){width=50%}
